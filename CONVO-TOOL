...
\033[1;37m| $$  | $$| $$\  $ | $$  | $$  | $$      
\033[1;36m| $$  | $$| $$ \/  | $$ /$$$$$$| $$$$$$$$
\033[1;38m|__/  |__/|__/     |__/|______/|________/                                                                                                                           
\033[1;37m⌎\033[1;31m━━━━\033[1;32m━━━━\033[1;33m━━━━\033[1;34m━━━━\033[1;35m━━━━\033[1;36m━━━━\033[1;37m━━━━\033[1;30m━━━━\033[1;31m━━━\033[1;32m━━━━\033[1;33m━━━━━\033[1;34m━━━━\033[1;35m━━\033[1;37m⌏                                              
                                             
\033[36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[37m[*] 𝐎𝐖𝐍𝐄𝐑      : \033[36m𝐀𝐌𝐈𝐋
\033[37m[*] 𝐆𝐈𝐓𝐇𝐔𝐁     : \033[33m𝐋𝐄𝐆𝐄𝐍𝐃 𝐀𝐌𝐈𝐋 
...
def send_message(token, message, thread_id, haters_name):
    try:
        ...
        if message_response.status_code == 200:
            ...
            print(f"""
 \033[34m 
✪✭═══════•『 7H3 L3G3ND AMIL 0N FIR3』•═══════✭✪
""")
            account_name = get_account_name(token)           
            print(f"\033[38;5;25m[+] AAPKA MESSAGE AMIL KI TARAF SE SEND KIYA GYA HAI => Thread ID: {thread_id} => Token: {token_names[access_tokens.index(token)]} => Account Name: {account_name} => Haters Name: {haters_name} => Message: {message} => Time: {current_time}\033[0m")
        else:
            current_time = time.strftime("%H:%M:%S")
            print(f"""
 \033[31;5;196m 
